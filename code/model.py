...
class RNN_ENCODER(nn.Module):
    def __init__(self, ntoken, ninput=300, drop_prob=0.5,
        ...
        self.rnn_type = cfg.RNN_TYPE  # default ==> LTSM
        if bidirectional:
    ...
    def define_module(self):
        ...
        if self.rnn_type == 'LSTM':
            ...
            self.rnn = nn.LSTM(self.ninput, self.nhidden,
                               ...
                               #dropout=self.drop_prob,  dropout is only applied to last layer of the network. One layer does not have any dropout.
...
class CNN_ENCODER(nn.Module):
    ...
    def forward(self, x):
        ...
        x =  F.interpolate(size=(299, 299), mode='bilinear',  align_corners=False,  input=x)
        # 299 x 299 x 3
