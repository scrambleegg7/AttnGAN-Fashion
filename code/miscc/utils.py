...
def build_super_images(real_imgs, captions, ixtoword,
    ...
    real_imgs =  F.interpolate(size=(vis_size, vis_size), mode='bilinear', align_corners=False, input=real_imgs)
    ...
    if lr_imgs is not None:
        ...
        lr_imgs =  F.interpolate(size=(vis_size, vis_size), mode='bilinear', align_corners=False, input=lr_imgs)
